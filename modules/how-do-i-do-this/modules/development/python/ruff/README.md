...
## Conteúdo
 ...
 - [`Configurações do Ruff`](#ruff-settings)
<!---
[WHITESPACE RULES]
...
> Aqui nós vamos entender algumas configurações básica do Ruff.
...
```
 ...
 - `exclude = ["..."]`
   - Define quais arquivos o Ruff deve ignorar:
     - Nesse caso, ele vai ignorar os arquivos listados dentro de `[]`.
