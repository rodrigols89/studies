# Agents, Customer, Orders (+FOREIGN KEY approach)

## Contents

 - [Creating a model](#model)
 - [Creating Agents table and inserting data](#agents)
 - [Creating customer table and inserting data](#customer)
 - [Creating orders table and inserting data](#orders)
...
To start, let's see the data model:

![logo](images/model-01.png)  

---

<div id="agents"></div>

## Creating Agents table and inserting data
...
## Creating orders table and inserting data
...
**REFERENCES:**  
[SQL Table](https://www.w3resource.com/sql/sql-table.php)  
