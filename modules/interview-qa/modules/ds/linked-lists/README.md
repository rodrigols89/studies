...
## Contents
 ...
 - **Node:**
   - [`How do I create a class to represent a Node for a Singly Linked List?`](#node-class-sll)
   - [`How do I create a class to represent a Node for a Double Linked List?`](#node-class-dll)
 - **Singly Linked List:**
   - [`How do I create a class to represent a Singly Linked List?`](#sll-class)
   ...
   - **Operations:**
     - [`How to add a new node to the front (push) of a Singly Linked List with O(1) time complexity?`](#sll-push)
     - [`How to add a new node at the end (append) of a Singly Linked List?`](#sll-append)
     - [`How to add a new node at the end (append) of a Singly Linked List with O(1) time complexity?`](#sll-append-constant)
     - [`How to traverse a singly linked list from the initial node to the last node?`](#sll-print-list-from-head)
 - **Double Linked List:**
...
## `How do I create a class to represent a Node for a Singly Linked List?`
...
## `How do I create a class to represent a Node for a Double Linked List?`
...
> **How to create a Node class to represent this Doubly Linked List?**
...
## `How do I create a class to represent a Singly Linked List?`
...
## `How to add a new node to the front (push) of a Singly Linked List with O(1) time complexity?`

> How to insert a new Node in the **front of a Singly Linked List (also called push)?**.
...
## `How to add a new node at the end (append) of a Singly Linked List?`

> How to inser a new Node **at the end of a Singly Linked List (also called append)?**.
...
## `How to add a new node at the end (append) of a Singly Linked List with O(1) time complexity?`

> How to implement the **append()** method with **constant Time Complexity O(1)?**.
...
**First, we need to modify the *SinglyLinkedList()* class to have the *tail attribute (reference)***:  
...
## `How to traverse a singly linked list from the initial node to the last node?`

> How to **traverse a Singly Linked List** from the Head until the last Node?.
