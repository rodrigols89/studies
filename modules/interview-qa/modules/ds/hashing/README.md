...
## Contents
 ...
 - **Fundamentals:**
   - [`What is the difference between variable-size data and fixed-size data (memory difference)?`](#vsd-vs-fsd)
   - [`What is hashing?`](#hashing-mapping)
   - [`What are the reasons for using Hashing?`](#hashing-reasons)
   - [`What are the components of a hashing process?`](#hashing-components)
...
## `What is the difference between variable-size data and fixed-size data (memory difference)?`
...
## `What are the reasons for using Hashing?`
...
## `What are the components of a hashing process?`
