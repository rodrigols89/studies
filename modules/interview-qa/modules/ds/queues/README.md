...
## Contents
 ...
 - [**Simple Queue:**](#intro-to-simples-queues)
 - [**Circular Queue:**](#intro-to-circular-queue)
 - [**Priority Queue:**](#)
 - [**Deque (Double-Ended Queue):**](#intro-to-deque)
 - **Queues using Builtin Functions:**
   - [`How to create a Queue class using built-in functions (insert/remove)`](#queue-class-using-python-builtin-functions)
 - [REFERENCES](#ref)
...
## `How to create a Queue class using built-in functions (insert/remove)`
