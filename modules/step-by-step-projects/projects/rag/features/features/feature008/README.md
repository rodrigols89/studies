...
## Conteúdo
 ...
 - [`Introdução ao arquivo Dockerfile`](#intro-to-dockerfiler)
 - [`Implementando o arquivo Dockerfile`](#implementing-dockerfile)
<!---
[WHITESPACE RULES]
- 50
--->
...
<div id="intro-to-dockerfiler"></div>

## `Introdução ao arquivo Dockerfile`
...
<div id="implementing-dockerfile"></div>

## `Implementando o arquivo Dockerfile`

Agora, nós vamos implementar o arquivo `Dockerfile`:
