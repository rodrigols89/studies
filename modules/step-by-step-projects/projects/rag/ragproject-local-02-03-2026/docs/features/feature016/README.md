# `Atualizando a view (ação) para exibir as pastas e arquivos no template "workspace_home.html"`

## Conteúdo

 - [`Atualizando a view (ação) workspace_home()`](#update-workspace-home-view)
...
<div id="update-workspace-home-view">

## `Atualizando a view (ação) workspace_home()`
...
A nossa view (açõa) `workspace_home()` vai ficar da seguinte maneira:
...
Agora, vamos explicar algumas partes do código acima (só o necessário, sem repetir o que já foi explicado em outras):
...
<div id="update-workspace-home-template">

## `Atualizando o template "workspace_home.html"`

Continuando, agora vamos atualiar nosso template [workspace_home.html](../../../workspace/templates/pages/workspace_home.html) para exibir qual usuário está logado:
