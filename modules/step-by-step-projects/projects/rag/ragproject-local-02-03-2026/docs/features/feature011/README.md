...
## Conteúdo
 ...
 - [`Criando as ROTAS/URLs login/ e logout/`](#mapping-urls)
 - [`Implementando a view (ação) home_view()`](#create-home-view)
 - [`Implementando (refatorando) a view (ação) login_view()`](#create-login-view)
 - [`Implementando a view (ação) logout_view()`](#create-logout-view)
 - [`Implementando o template sidebar.html`](#create-sidebar-template)
 - [`Implementando o template home.html`](#create-home-template)
<!---
[WHITESPACE RULES]
- 50
--->
...
## `Criando as ROTAS/URLs login/ e logout/`
...
from .views import (
    create_account, home_view, login_view, logout_view
)
...
<div id="create-home-view"></div>

## `Implementando a view (ação) home_view()`

Agora, nós vamos implementar a view (ação) `home_view`:
...
## `Implementando (refatorando) a view (ação) login_view()`
...
<div id="create-sidebar-template"></div>

## `Implementando o template sidebar.html`

Antes de começar a implementar a página home, vamos criar o template `sidebar.html` que será utilizado em ambas as páginas autenticadas (`home` e `workspace`):
...
<div id="create-home-template"></div>
