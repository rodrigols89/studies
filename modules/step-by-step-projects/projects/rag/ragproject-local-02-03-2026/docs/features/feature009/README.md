# `Criando App "users" + Landing Page`

## Conteúdo

 - [`Instalando o App "users"`](#install-users-app)
 - [`O que é uma Landing Page?`](#intro-to-landing-page)
 - [`Criando o HTML base (base.html)`](#create-base-html)
 - [`Criando a view (ação) login_view()`](#creating-login-view)
 - [`Criando icones (SVG) para os logins sociais`](#creating-icons-for-social-logins)
 - [`Criando o nosso index.html (Landing Page)`](#creating-our-index-html)
 - [`Relacionando as ROTAS/URL's do App "users" com o nosso projeto /core`](#mapping-urls)
<!---
[WHITESPACE RULES]
- 50
--->
...
Antes de começar a criar nossa `Landing Page`, vamos criar o nosso `HTML base` que é responsável por aplicar *configurações globais* aos nossos templates:
...
<div id="creating-icons-for-social-logins"></div>

## `Criando icones (SVG) para os logins sociais`

Aqui nós vamos criar os icones SVG que serão usados nos botões de login social com GitHub e Google:
...
<div id="creating-our-index-html"></div>

## `Criando o nosso index.html (Landing Page)`

O `index.html` vai representar a nossa *Página Inicial (Landing Page)*:
...
## `Relacionando as ROTAS/URL's do App "users" com o nosso projeto /core`

Aqui, vamos configurar o nosso projeto para reconhecer as ROTAS/URL's do App "users":
