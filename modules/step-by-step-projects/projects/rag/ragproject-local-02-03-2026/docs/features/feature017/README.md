...
## Conteúdo
 ...
 - [`Criando o JavaScript "workspace_home.js"`](#create-workspace_home-js)
<!---
[WHITESPACE RULES]
- 50
--->
...
Porém, agora nós temos a seguinte situação, quando nós passamos o mouse em cima de alguma pasta ou arquivo:
 ...
 - **NOTE:** Porém, eu não consigo abrir ou selecionar nenhum deles ainda.
...
<div id="create-workspace_home-js"></div>

## `Criando o JavaScript "workspace_home.js"`

> **⚠️ NOTE:**  
> Até aqui nós paramos na seguinte situação: `Não conseguimos abrir ou selecionar nenhum deles ainda.`

### `Código Completo`

Para resolver isso vamos criar o seguinte `workspace_home.js`:
...
De início vamos criar o seguinte código JavaScript:
...
> **⚠️ Ué, eu atualizei minha página e não funcionou!**  
> Primeiro, nós precisamos referenciar esses códigos JavaScritp no nosso template `workspace_home.html`:
...
**Ótimo, agora se você testar no seu navegador, tudo vai funcionar corretamente!**
