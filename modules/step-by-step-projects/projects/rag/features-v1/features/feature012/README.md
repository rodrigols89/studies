...
## Conteúdo
 ...
 - [`Instalando o Ruff`](#install-ruff)
 - [`[tool.ruff]`](#tool-ruff)
...
<div id="install-ruff"></div>

## `Instalando o Ruff`

De início, a primeira coisa que nós vamos precisar fazer é instalar **Ruff** no nosso projeto:
